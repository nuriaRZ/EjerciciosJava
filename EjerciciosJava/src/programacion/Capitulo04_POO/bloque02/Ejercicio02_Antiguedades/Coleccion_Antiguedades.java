...
public class Coleccion_Antiguedades {

	public void main(String[] args) {
		Joyas joya = new Joyas(1996, "argentina", 80.90f, "plata");
		Libros libro = new Libros("1999", "EEUU", 15.90f, "JRRTolkien", "El señor de los Anillos");
		Muebles mueble = new Muebles("2010", "España", 118.90f, "madera", "azul");
