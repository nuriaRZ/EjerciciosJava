...
public class Bloque03_Wrappers {
	...
	String str = JOptionPane.showInputDialog("Introduce una contrase�a, debe contener:\n"+
	...
	char cadenaCaracteres[] = new char [str.length()] ;
		...
		if (mayuscula == true && minuscula == true && digito == true && noAlfanumerico == true) {
			...
			System.out.println("Tu contrase�a es v�lida");
		}else {
			System.out.println("Su contrase�a no es v�lida");
		}	
